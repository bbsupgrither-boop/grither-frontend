...
export function AdminTasks({ currentAdminPage = 'tasks', setCurrentAdminPage }: AdminTasksProps) {
  ...
  // Пустой массив активных задач (администраторы создадут задачи самостоятельно)
  const [activeTasks, setActiveTasks] = useState<Task[]>([]);

  // Пустой массив выполненных задач
            ...
            <div className="p-6">
              {selectedTask && (
                <div className="space-y-4">
                  ...
                  {/* Кнопки действий внизу (только для активных задач) */}
