...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-40 modal-backdrop-light dark:modal-backdrop-dark",
        className,
      )}
      {...props}
    />
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          ...
          opacity: '1',
          borderRadius: side === 'left' ? '0 16px 16px 0' : side === 'right' ? '16px 0 0 16px' : '16px',
